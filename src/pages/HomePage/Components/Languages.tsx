...
const languages = [
  {
    ...
    color: "#00b4d8",
    // Real catalogue figures. 72 tutorials split evenly across the three
    // supported languages, one full course each.
    tutorials: "24",
    detail: "1 full course",
...
// Only the three languages the platform actually sandboxes and executes.
// Java and HTML/CSS were listed here with invented counts, promising content
// that does not exist and cannot run in the editor.
  ...
  return (
    <section className="bg-[#0a0e27] py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Language Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-32 max-w-4xl mx-auto">
          {languages.map((lang) => (
            <div
              key={lang.name}
                ...
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <div className="w-full text-center space-y-1">
                    <div className="text-[#6272a4] text-xs font-mono">
                      <span className="text-[#00e676]">{lang.tutorials}</span>{" "}
                      tutorials
                    </div>
                    <div className="text-[#6272a4] text-xs font-mono">
                      <span className="text-[#00b4d8]">{lang.detail}</span>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="relative terminal-window backdrop-blur-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* These tracks are planned, not published. They previously
                      advertised exact lesson counts and durations for content
                      that does not exist in the catalogue. */}
                  <div className="flex items-center gap-6 mb-4 text-sm font-mono">
                    <span className="px-2 py-1 rounded bg-[#8b5cf6]/15 text-[#8b5cf6] text-xs border border-[#8b5cf6]/30">
                      planned
                    </span>
