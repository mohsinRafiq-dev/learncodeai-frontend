...
export default function LessonManagement({
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm bg-black/50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d1230] border border-[#2a3050] rounded-lg w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        <div className="px-6 py-4 border-b border-[#2a3050] flex items-center justify-between">
          <div>
            <div className="text-sm text-gray-400 mb-1">
              Admin Panel / Courses / {course.title} / {section.title} / Lesson
              Management
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium text-gray-100">Lessons</h3>
        ...
        <div className="px-6 py-4 border-t border-[#2a3050] flex items-center justify-end">
          <button
            onClick={onClose}
